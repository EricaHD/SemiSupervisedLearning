...
def create_parser():
    ...
    parser.add_argument('--unsup-subdir', type=str, default='unsupervised',
                        help='the subdirectory inside the data directory that contains the unsupervised data')
    ...
    # SWA and fastSWA
    parser.add_argument('--num-cycles', default=0, type=int, help='If 1 or more, use additional cycles after args.epochs')
    parser.add_argument('--cycle-interval', default=10, type=int, help='the number of epochs for small cyclical learning rate')
    ...
    parser.add_argument('--unsup-augment', default=None, type=str, choices=['cifar100', 'gan_cifar10', 'tiny_500k', 'tiny_237k', 'tiny_all'], help='augment unsupervised set with a given dataset')
