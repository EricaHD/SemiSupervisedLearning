...
class Model(nn.Module):
    def __init__(self, block=ShakeShakeBlock, layers=[4, 4, 4], channels=96, groups=1, num_classes=1000, downsample='shift_conv'):
        super().__init__()
        assert len(layers) == 3
        ...
        self.load_weights('/scratch/ijh216/ssl/ssl_shake_mini_augment/2019-05-06_18-04-18/10/transient/checkpoint.325.ckpt')
    ...
    def load_weights(self, pretrained_model_path, cuda=True):
        ...
        for k, v in pretrained_model['ema_state_dict'].items():
